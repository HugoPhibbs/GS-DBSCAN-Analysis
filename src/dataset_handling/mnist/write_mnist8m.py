...
#         print(f"curr n: {n}")
#         sample_filename = f"{REPO_DIR}/data/mnist8m/samples/{type_str}/data/mnist8m_{type_str}_sample_{n}.bin"
#         sample_labels_filename = f"{REPO_DIR}/data/mnist8m/samples/{type_str}/labels//mnist8m_for{type_str}_sample_labels_{n}.bin"
#
